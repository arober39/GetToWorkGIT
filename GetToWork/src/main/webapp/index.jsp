...
<div class="w3-top">
  <div class="w3-bar w3-theme w3-top w3-left-align w3-large">
    ...
    <a href="./ResumeCharts.jsp" class="w3-bar-item w3-button w3-hide-small w3-hide-medium w3-hover-white">Resumes</a>
...
<a href="./ResumeUpload.jsp">link to resume upload</a>
